# a11y-url-coverage Specification

## Purpose
How the accessibility gate decides which pages to audit: the URL list is generated from the
digest data present rather than hand-maintained, required render shapes are pinned by committed
fixtures, and those fixtures never reach a production build.

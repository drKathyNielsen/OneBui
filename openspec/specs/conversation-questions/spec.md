# conversation-questions Specification

## Purpose
How the UI renders an article's optional `questions` prompts: attached to their article,
absent without error, and announced as a labelled group.
